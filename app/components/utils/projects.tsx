...
import projects, { Project } from "@/app/components/data/projects";
...
const ProjectCard = ({ project }: { project: Project }) => {
  ...
  return (
    <div className="flex w-full items-center justify-center">
      <ResponsiveDialog>
        <ResponsiveDialogTrigger className="flex w-full max-w-[400px] justify-center bg-transparent">
          <div
          ...
          >
            <Image
              ...
              // src={project.src}
              src={imgError || !project.src ? "/file.svg" : project.src}
              alt={project.title}
              width={400}
              height={267}
